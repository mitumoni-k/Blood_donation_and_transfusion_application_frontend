    ...
    <>
      <nav className="navbar-container">
        ...
        <div className={`navbar ${menuOpen ? "active" : ""}`}>
          {!isLoggedIn && (
            <>
              <a href="/Login" className="login" onClick={toggleMenu}>
                Login
              </a>
              <a href="/Signup" className="signup" onClick={toggleMenu}>
                Register
                <FontAwesomeIcon icon={faUser} className="register-icon" />
              </a>
            </>
          ...
          {isLoggedIn && (
            <>
              <a href="/MyProfile" className="signup" onClick={toggleMenu}>
                My Profile
                <FontAwesomeIcon icon={faUser} className="register-icon" />
              </a>
              <button className="signup" onClick={() => { handleLogout(); toggleMenu(); }}>
                Logout
              </button>
            </>
          )}
